...
public class weddingsuititem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weddingsuititem);
        Products p= new Products();
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products").child("Category").child("Suites").child("wedding suit");
                        ...
                        reference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if (u.getUsertype().equals("admin")) {
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(weddingsuititem.this);
                                    ...
                                    builder.setItems(sequence, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                                ...
                                                databaseReference.child(model.getID()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(weddingsuititem.this, "Item removed ", Toast.LENGTH_SHORT).show();

                                                            Intent intent = new Intent(weddingsuititem.this, HomeActivity.class);
                                            ...
                                            if (i == 2) {
                                                Intent intent = new Intent(weddingsuititem.this, ProdetsuW.class);
                                    ...
                                    if (!u.getPhone().equals(model.getProowner())) {
                                        ...
                                        builder.setItems(sequence, new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialogInterface, int i) {
                                                ...
                                                if (i == 2) {
                                                    Intent intent = new Intent(weddingsuititem.this, EditPro.class);
                                                    intent.putExtra("pid", model.getID());
