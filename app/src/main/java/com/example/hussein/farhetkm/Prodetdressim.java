...
public class Prodetdressim extends AppCompatActivity {
        ...
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (state.equals("order shipped")){
                    Toast.makeText(Prodetdressim.this, "you can add purchase more products , once your order is shipped or confirmed",Toast.LENGTH_LONG).show();
                }
                else {
                    addtocartlist();
                }
        ...
        carlistref.child("User View")
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(Prodetdressim.this,"added to cart list", Toast.LENGTH_LONG).show();
                    Intent intent= new Intent(Prodetdressim.this, HomeActivity.class);
