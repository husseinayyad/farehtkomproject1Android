...
public class Adddresscat extends AppCompatActivity {

    RadioGroup radioGroup;
    RadioButton r1 ,r2 ;
    String radiotext;
    private  String getcatgory ,category11 , des1  ,type1,
            subcategory1, price1 , savedata , savetime , proudctrandomkey ,owner, donlowadimg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adddresscat);
       ...
       // category=findViewById(R.id.procat);
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(this,
                R.array.dresssub_array, android.R.layout.simple_spinner_item);
...
inputimage.setImageURI(imageuri);
    ...
    private void validaadata() {
        ...
        if (imageuri==null){
            Toast.makeText(this,"Product image is null",Toast.LENGTH_LONG).show();

        }
        else if (TextUtils.isEmpty(category11)){
            Toast.makeText(this,"Product Category is empty",Toast.LENGTH_LONG).show();

        }
        else if (TextUtils.isEmpty(des1)){
            Toast.makeText(this,"Product description  is empty",Toast.LENGTH_LONG).show();
...
uploadTask.addOnFailureListener(new OnFailureListener() {
    ...
    public void onFailure(@NonNull Exception e) {
        ...
        Toast.makeText(Adddresscat.this," Error : "+message,Toast.LENGTH_LONG).show();
        loadingBar.dismiss();
    }
}).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
    @Override
    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
        Toast.makeText(Adddresscat.this,"  image uploaded successfully ",Toast.LENGTH_LONG).show();
        Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(Adddresscat.this,"  image save to database",Toast.LENGTH_LONG).show();
                    saveprointodatabase();
                }
            }
        });
    ...
    private void saveprointodatabase() {
        ...
        databaseReference.child(category11).child(subcategory1).child(proudctrandomkey).updateChildren(objectHashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    loadingBar.dismiss();
                    Intent  intent = new Intent(Adddresscat.this , AdminCategoryActivity.class);
                 startActivity(intent);


                    Toast.makeText(Adddresscat.this," Products is added",Toast.LENGTH_LONG).show();
                }
                else {
                    loadingBar.dismiss();
                    Toast.makeText(Adddresscat.this," error : "+ task.getException().toString(),Toast.LENGTH_LONG).show();
