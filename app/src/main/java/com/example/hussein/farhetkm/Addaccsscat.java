...
public class Addaccsscat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addaccsscat);
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(this,
                R.array.acssssub_array, android.R.layout.simple_spinner_item);
    ...
    private void storeproductinfo() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(Addaccsscat.this," Error : "+message,Toast.LENGTH_LONG).show();
                loadingBar.dismiss();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(Addaccsscat.this,"  image uploaded successfully ",Toast.LENGTH_LONG).show();
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(Addaccsscat.this,"  image save to database",Toast.LENGTH_LONG).show();
                            saveprointodatabase();
                        }
                    }
                });
    ...
    private void saveprointodatabase() {
        ...
        databaseReference.child(category11).child(subcategory1).child(proudctrandomkey).updateChildren(objectHashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    loadingBar.dismiss();
                    Intent  intent = new Intent(Addaccsscat.this , AdminCategoryActivity.class);
                    startActivity(intent);


                    Toast.makeText(Addaccsscat.this," Products is added",Toast.LENGTH_LONG).show();
                }
                else {
                    loadingBar.dismiss();
                    Toast.makeText(Addaccsscat.this," error : "+ task.getException().toString(),Toast.LENGTH_LONG).show();
